...
if (!code.includes('toggleAutoSync')) {
    code = code.replace('const [inputValue, setInputValue]', toggleFuncs + '\n  const [inputValue, setInputValue]');
}
...
if (code.includes(aiToggleMatch) && !code.includes('Auto-Sync Dropi')) {
    const newUI = `
...
console.log('Injected Auto toggles!');
