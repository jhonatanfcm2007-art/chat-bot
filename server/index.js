...
22. NÚMERO DE TELÉFONO (¡ESTRICTO!): ¡TÚ YA TIENES el número de teléfono del cliente! Su número real es ${from.split('@')[0].split('_')[0]}. Está ESTRICTAMENTE PROHIBIDO usar el número de ejemplo 3001234567. Si lo usas, arruinarás el pedido. Al generar la etiqueta final, usa SIEMPRE [TELEFONO: ${from.split('@')[0].split('_')[0]}] a menos que el cliente te dé otro distinto.`;
