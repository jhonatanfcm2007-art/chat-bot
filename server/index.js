...
(function initKnowledgeBase() {
    ...
    knowledgeBaseDb.forEach(prod => {
        if (prod.name.toLowerCase().includes('shilajit') && !prod.details.includes('FLUJO DE VENTAS ESTRICTO')) {
